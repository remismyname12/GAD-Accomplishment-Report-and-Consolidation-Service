            ...
            <table id="report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style={{ ...tvStyles, backgroundColor: '#00B0F0' }}>Calculate Total Males for Mandate</td>
                        <td style={{ ...tvStyles, backgroundColor: '#FF66FF' }}>Calculate Total Females for Mandate</td>
                        <td style={tnStyles}></td>
                        <td style={tnStyles}>Calculate Total Actual Expenses</td>
                        <td style={tnStyles}>Calculate Total Attribution</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style={{ ...tnStyles, backgroundColor: '#C5E0B3' }} colSpan="11"><b>TOTAL PER MANDATE. MAKE MANDATES TABLE TO MAP</b></td>
                    </tr>
                </tbody>
            </table>
        </div>
